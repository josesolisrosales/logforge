...
class PerformanceMonitor:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "logs_per_second": self.total_logs_generated / duration if duration > 0 else 0,
    ...
    def get_real_time_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "current_logs_per_second": self.total_logs_generated / duration if duration > 0 else 0,
...
class ProgressReporter:
    ...
    def report_progress(self, logs_generated: int) -> None:
        ...
        if (logs_generated - self.last_report_count >= self.report_interval or 
            current_time - self.last_report_time >= 5.0):
            ...
            if duration > 0:
                ...
                recent_rate = (logs_generated - self.last_report_count) / (current_time - self.last_report_time)
                ...
                print(f"Progress: {logs_generated:,}/{self.total_logs:,} ({progress_percent:.1f}%) "
    ...
    def report_completion(self, final_count: int) -> None:
        ...
        print(f"Generation complete: {final_count:,} logs in {duration:.2f}s "
...
class BenchmarkRunner:
    ...
    def run_generation_benchmark(config, iterations: int = 3) -> Dict[str, Any]:
        ...
        avg_results = {
            ...
            "avg_logs_per_second": sum(r["logs_per_second"] for r in results) / iterations,
            "avg_memory_usage": sum(r["peak_memory_usage_mb"] for r in results) / iterations,
            "avg_cpu_usage": sum(r["peak_cpu_usage_percent"] for r in results) / iterations,
