...
class TestGenerateCommand:
        ...
        try:
            with patch('logsmith.cli.LogGenerator') as mock_generator:
                ...
                result = self.runner.invoke(
                    generate, ['--count', '100', '--output', temp_path]
                )
                assert result.exit_code == 0
    ...
    def test_generate_with_json_format(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result = self.runner.invoke(
                generate, ['--count', '100', '--format', 'json']
            )
            assert result.exit_code == 0
    ...
    def test_generate_with_compression(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result = self.runner.invoke(
                generate, ['--count', '100', '--compression', 'gzip']
            )
            assert result.exit_code == 0
    ...
    def test_generate_with_custom_fields(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result = self.runner.invoke(
                generate, ['--count', '100', '--custom-fields', custom_fields]
            )
            assert result.exit_code == 0
    ...
    def test_generate_with_level_distribution(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result = self.runner.invoke(
                generate, ['--count', '100', '--level-dist', level_dist]
            )
            assert result.exit_code == 0
    ...
    def test_generate_with_config_file(self):
        ...
        try:
            with patch('logsmith.cli.LogGenerator') as mock_generator:
                ...
                result = self.runner.invoke(generate, ['--config', config_path])
                assert result.exit_code == 0
    ...
    def test_generate_validate_only(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result = self.runner.invoke(generate, ['--count', '100', '--validate-only'])
            assert result.exit_code == 0
    ...
    def test_generate_benchmark_mode(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result = self.runner.invoke(generate, ['--count', '100', '--benchmark'])
            assert result.exit_code == 0
    ...
    def test_generate_invalid_format(self):
        ...
        result = self.runner.invoke(
            generate, ['--count', '100', '--format', 'invalid_format']
        )
        assert result.exit_code != 0
    ...
    def test_generate_invalid_count(self):
        ...
        result = self.runner.invoke(generate, ['--count', '0'])
        assert result.exit_code != 0
    ...
    def test_generate_invalid_json_custom_fields(self):
        ...
        result = self.runner.invoke(
            generate, ['--count', '100', '--custom-fields', 'invalid_json']
        )
        assert result.exit_code != 0
    ...
    def test_generate_invalid_json_level_dist(self):
        ...
        result = self.runner.invoke(
            generate, ['--count', '100', '--level-dist', 'invalid_json']
        )
        assert result.exit_code != 0
        assert "Invalid JSON" in result.output
    ...
    def test_benchmark_with_output_file(self):
        ...
        try:
            with patch('logsmith.cli.BenchmarkRunner') as mock_runner:
                ...
                result = self.runner.invoke(
                    benchmark, ['--count', '1000', '--output', temp_path]
                )
                assert result.exit_code == 0
...
class TestInitConfigCommand:
    ...
    def test_init_config_with_options(self):
        ...
        try:
            result = self.runner.invoke(
                init_config,
                ['--output', temp_path, '--format', 'json', '--count', '5000'],
            )
            assert result.exit_code == 0
...
class TestValidateConfigCommand:
    ...
    def test_validate_config_valid(self):
        ...
        config_data = {"total_logs": 1000, "output": {"format": "json"}}
...
class TestAnomalyParameters:
    ...
    def test_generate_with_seed(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result = self.runner.invoke(
                generate, ['--count', '10', '--seed', '42', '--no-progress']
            )
    ...
    def test_generate_with_anomalies_enabled(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result = self.runner.invoke(
                generate, ['--count', '10', '--anomalies', '--no-progress']
            )
    ...
    def test_generate_with_anomaly_config_file(self):
        ...
        anomaly_config_data = {"enabled": True, "base_rate": 0.15}
    ...
    def test_seed_determinism_via_cli(self):
        ...
        with patch('logsmith.cli.LogGenerator') as mock_generator:
            ...
            result1 = self.runner.invoke(
                generate,
                ['--count', '2', '--seed', '42', '--format', 'json', '--no-progress'],
            )
