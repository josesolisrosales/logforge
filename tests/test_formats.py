...
class TestLogfmtFormatter:
    ...
    def test_value_quoting(self):
        ...
        formatter = LogfmtFormatter()
        log_entry = {"key1": "value with spaces", "key2": "simple_value"}
...
class TestCEFFormatter:
    ...
    def test_basic_format(self):
        ...
        log_entry = {"level": "INFO", "message": "Test event"}
...
class TestFormatterFactory:
    ...
    def test_create_custom_formatter(self):
        ...
        formatter = FormatterFactory.create_formatter(
            LogFormat.CUSTOM, template="{timestamp} {message}"
        )
    ...
    def test_create_with_kwargs(self):
        ...
        formatter = FormatterFactory.create_formatter(LogFormat.JSON, pretty=True)
        assert isinstance(formatter, JSONFormatter)
